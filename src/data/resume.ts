...
export const metrics = [
  {
    ...
    detail: 'Manual & Automation across retail, supply-chain, e-commerce, education',
  },
  {
    value: 3,
    prefix: '',
    ...
    detail: 'Retail/CPG, Education, Supply Chain',
  },
  {
    value: 2,
    prefix: '',
...
export const experience: Role[] = [
  {
    ...
    chips: ['Playwright + TypeScript', 'JIRA Xray', 'Postman', 'JMeter'],
  },
  {
